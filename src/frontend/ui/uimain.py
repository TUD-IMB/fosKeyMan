...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon8 = QIcon()
        icon8.addFile(u":/icons/icons/deactive.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionDeactive.setIcon(icon8)
        self.actionSearch = QAction(MainWindow)
        self.actionSearch.setObjectName(u"actionSearch")
        self.actionSearch.setCheckable(True)
        icon9 = QIcon()
        icon9.addFile(u":/icons/icons/search.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/icons/icons/edit.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionEdit.setIcon(icon10)
